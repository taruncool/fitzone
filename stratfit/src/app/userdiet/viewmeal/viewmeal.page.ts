...
export class ViewmealPage implements OnInit {
  ...
  ngOnInit() {
   ...
   for(var tc=0;tc<this.foodItems.length;tc++){
    ...
    for(let m =0;m<this.selectedFoodItemsFilter.length;m++){
     ...
     this.mealCals = Math.round(mealCal);
     this.mealFatGmss = Math.round(mealFatGms);
     this.mealProGmss = Math.round(mealProGms);
     this.mealCarbsGmss = Math.round(mealCarbsGms);
  ...
  editMeal(){
   ...
   // if(localStorage.getItem('nutritionData')!==""){
     ...
     // console.log(finalFoodData);
      ...
      var mealCals = Math.round(mealCal);
      var mealFatGmss = Math.round(mealFatGms);
      var mealProGmss = Math.round(mealProGms);
      var mealCarbsGmss = Math.round(mealCarbsGms);
  ...
  public addFoodItem(){
    ...
    this.foodModal = this.modalCtrl.create({component:FilterfoodPage,
