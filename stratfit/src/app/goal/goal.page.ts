      ...
      var usertoken = localStorage.getItem('usertoken');
        this.apiService.filtersql(usertoken,this.filters).subscribe((response)=>{
          ...
          let res = JSON.parse(userStr);
            ...
            console.log("json response1",res.success.filterValue.parentGoal);
             this.goal = res.success.filterValues.parentGoal;
            let plan_goals = this.goal.plan_goals;
            console.log("json response..goal",this.goal);
            console.log("json response..2",plan_goals);
            // console.log("json response..3",res.success.filterValues.parentGoal.plan_goals);
